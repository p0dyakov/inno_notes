...
##### **4.1. Construct a DPDA for $L = \{a^n b^{2n} \mid n \geq 1\}$** (Lab 5, Problem 1)
...
##### **4.2. Construct a DPDA for $P = \{xycy^Rx^R \mid x \in \{a,b\}^*, y \in \{d,e\}^*, |x|>0\}$** (Lab 5, Problem 2)
...
##### **4.3. Construct a DPDA for Balanced Brackets and Parentheses** (Lab 5, Problem 3)
...
##### **4.4. Construct a DPDA for $L_1 = \{w \in \{a,b\}^* \mid \phi(w,a) = \phi(w,b)\}$** (Lab 5, Problem 4)
...
##### **4.5. Construct a DPDA for $L_2 = \{a^n b^m a^m b^n \mid n > 0, m > 0\}$** (Lab 5, Problem 5)
...
##### **4.6. Construct a DPDA for Arithmetic Expression Parentheses** (Lab 5, Homework 1)
