...
##### **4.5. Construct a DPDA for $L = \{a^n b^{2n} \mid n \geq 1\}$** (Lab 5, Problem 1)
...
##### **4.6. Construct a DPDA for $P = \{xycy^Rx^R \mid x \in \{a,b\}^*, y \in \{d,e\}^*, |x|>0\}$** (Lab 5, Problem 2)
...
##### **4.7. Construct a DPDA for Balanced Brackets and Parentheses** (Lab 5, Problem 3)
...
##### **4.8. Construct a DPDA for $L_1 = \{w \in \{a,b\}^* \mid \phi(w,a) = \phi(w,b)\}$** (Lab 5, Problem 4)
...
##### **4.9. Construct a DPDA for $L_2 = \{a^n b^m a^m b^n \mid n > 0, m > 0\}$** (Lab 5, Problem 5)
...
##### **4.10. Construct a DPDA for Arithmetic Expression Parentheses** (Lab 5, Homework 1)
...
##### **4.1. Prove That $L = \{a^n b^n c^n \mid n \in \mathbb{N}\}$ Is Not Context-Free** (Tutorial 6, Example 1)
...
##### **4.2. Construct a DPDA for $L_1 = \{a^n b^n \mid n \geq 1\}$** (Tutorial 6, Example 2)
...
##### **4.3. Construct a DPDA for $L_2 = \{a^n b a^n \mid n \in \mathbb{N}^+\}$** (Tutorial 6, Example 3)
...
##### **4.4. Construct a DPDA for $L_3 = \{vcv^R \mid v \in \{a,b\}^*\}$** (Tutorial 6, Example 4)
