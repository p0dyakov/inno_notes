...
```{dot}
//| fig-cap: "FST mapping walked/talked to walk/talk"
//| fig-width: 6.2
//| fig-height: 2.4
digraph fst_walked {
  rankdir=LR;
...
```{dot}
//| fig-cap: "FST erasing every second a while requiring the string to end in b"
//| fig-width: 5.8
//| fig-height: 2.4
...
```{dot}
//| fig-cap: "Two parity FSAs: even number of 1s and odd number of 0s"
//| fig-width: 6.2
//| fig-height: 2.4
digraph parity_pair {
  rankdir=LR;
...
```{dot}
//| fig-cap: "Product construction viewpoint for union, intersection, and difference"
//| fig-width: 6.2
//| fig-height: 2.5
digraph product_ops {
  rankdir=LR;
...
```{dot}
//| fig-cap: "Completing an incomplete FSA with a trap state before taking the complement"
//| fig-width: 5.4
//| fig-height: 2.2
...
```{dot}
//| fig-cap: "FSAs for divisibility by 2 and divisibility by 3 in binary"
//| fig-width: 6.3
//| fig-height: 2.7
...
```{dot}
//| fig-cap: "Product automaton for combining divisibility by 2 and divisibility by 3"
//| fig-width: 6.3
//| fig-height: 2.8
digraph divisible_6 {
  rankdir=LR;
