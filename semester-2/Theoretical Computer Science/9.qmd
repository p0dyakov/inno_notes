...
##### **4.3. Convert NFSA to DFSA: Constrained Language over $\{a, b\}$** (Lab 9, Task 3)
...
##### **4.4. Convert NFSA to DFSA: Strings Ending in $ab$, $bc$, or $ca$** (Lab 9, Task 4)
...
##### **4.6. Build Regular Expressions over $\{a, b\}$** (Lab 9, Task 6)
...
##### **4.12. Apply Thompson's Construction to $(1 \mid 01)^*$** (Tutorial 9, Example 3)
