...
##### **4.5. Prove $L_1 = \{vv^R \mid v \in \{a,b\}^*\}$ is Not Regular** (Lab 4, Exercise 1)
...
##### **4.6. Prove $L_2 = \{v \mid v \text{ has equal numbers of } a\text{'s and } b\text{'s}\}$ is Not Regular** (Lab 4, Exercise 2)
...
##### **4.7. Prove $L_3 = \{a^{n!} \mid n \geq 0\}$ is Not Regular** (Lab 4, Exercise 3)
...
##### **4.8. Prove $L_4 = \{a^n b^l c^{n+l} \mid n, l \geq 0\}$ is Not Regular** (Lab 4, Exercise 4)
...
##### **4.1. Prove $L = \{a^n b^n \mid n > 0\}$ is Not Regular** (Tutorial 5, Example 1)
...
##### **4.2. Prove $L_2 = \{a^n b\, a^n \mid n \in \mathbb{N}\}$ is Not Regular** (Tutorial 5, Example 2)
...
##### **4.3. Construct a PDA for $L_1 = \{a^n b^n \mid n \geq 1\}$** (Tutorial 5, Example 3)
...
##### **4.4. Construct a PDA for $L_2 = \{a^n b\, a^n \mid n \geq 1\}$** (Tutorial 5, Example 4)
