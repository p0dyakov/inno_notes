...
##### **4.1. Prove $L_1 = \{vv^R \mid v \in \{a,b\}^*\}$ is Not Regular** (Lab 4, Task 1)
...
##### **4.2. Prove $L_2 = \{v \mid v \text{ has equal numbers of } a\text{'s and } b\text{'s}\}$ is Not Regular** (Lab 4, Task 2)
...
##### **4.3. Prove $L_3 = \{a^{n!} \mid n \geq 0\}$ is Not Regular** (Lab 4, Task 3)
...
##### **4.4. Prove $L_4 = \{a^n b^l c^{n+l} \mid n, l \geq 0\}$ is Not Regular** (Lab 4, Task 4)
