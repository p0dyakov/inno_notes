...
##### **4.2. Design a TM for $L_2 = \{wcw^R \mid w \in \{a,b\}^+\}$** (Lab 7, Task 2)
...
##### **4.3. Design a TM for Palindromes** (Lab 7, Task 3)
...
##### **4.4. Design a TM for $L_4 = \{a^n b^n \mid n \geq 0\} \cup \{a^n b^{2n} \mid n \geq 0\}$** (Lab 7, Task 4)
