...
##### **4.1. Design a TM for $L_1 = \{wcw \mid w \in \{a,b\}^+\}$** (Lab 7, Task 1)
...
##### **4.2. Design a TM for $L_5 = \{(ab)^n \mid n \geq 0\}$** (Lab 7, Homework 1)
...
##### **4.3. Design a TM for $L_2 = \{wcw^R \mid w \in \{a,b\}^+\}$** (Lab 7, Task 2)
...
##### **4.4. Design a TM for $L_6 = \{a^n b^{2n} c^{3n} \mid n \geq 0\}$** (Lab 7, Homework 2)
...
##### **4.5. Design a TM for Palindromes** (Lab 7, Task 3)
...
##### **4.6. Design a TM for $L_4 = \{a^n b^n \mid n \geq 0\} \cup \{a^n b^{2n} \mid n \geq 0\}$** (Lab 7, Task 4)
...
##### **4.9. Design a TM for $L = \{a^n b^n \mid n > 0\}$** (Tutorial 9, Task 1)
...
##### **4.10. Design a TM for $L = \{a^n b^n c^n \mid n > 0\}$** (Tutorial 9, Task 2)
