...
##### **4.3. Design a TM for $L_1 = \{wcw \mid w \in \{a,b\}^+\}$** (Lab 7, Exercise 1)
...
##### **4.4. Design a TM for $L_2 = \{wcw^R \mid w \in \{a,b\}^+\}$** (Lab 7, Exercise 2)
...
##### **4.5. Design a TM for Palindromes** (Lab 7, Exercise 3)
...
##### **4.6. Design a TM for $L_4 = \{a^n b^n \mid n \geq 0\} \cup \{a^n b^{2n} \mid n \geq 0\}$** (Lab 7, Exercise 4)
...
##### **4.7. Design a TM for $L_5 = \{(ab)^n \mid n \geq 0\}$** (Lab 7, Homework 1)
...
##### **4.8. Design a TM for $L_6 = \{a^n b^{2n} c^{3n} \mid n \geq 0\}$** (Lab 7, Homework 2)
...
##### **4.1. Trace a TM on $a^n b^n$** (Lecture 8, Example 1)
...
##### **4.2. Trace a TM on $a^n b^n c^n$** (Lecture 8, Example 2)
