...
```{dot}
//| fig-cap: "Standard FSA state-diagram notation"
//| fig-width: 4.8
//| fig-height: 1.9
...
digraph turnstile_lab3 {
  ...
  edge [fontname="Helvetica", fontsize=10, color="#355c7d"];
  start [shape=point, width=0.1, fillcolor=black];
  locked [label="Locked", shape=doublecircle, fillcolor="#d7f0c2"];
  unlocked [label="Unlocked", fillcolor="#e8f4f8"];
  start -> locked;
...
```{dot}
//| fig-cap: "FSA used to test which strings are accepted"
//| fig-width: 5.6
//| fig-height: 2.1
digraph task1_fsa {
  rankdir=LR;
...
```{dot}
//| fig-cap: "Complete FSA for binary strings starting with 1"
//| fig-width: 4.8
//| fig-height: 2
...
```{dot}
//| fig-cap: "Complete FSA for strings that do not start with 1"
//| fig-width: 4.8
//| fig-height: 2
...
```{dot}
//| fig-cap: "Complete FSA where every 0 must be immediately followed by 1"
//| fig-width: 4.8
//| fig-height: 2
...
```{dot}
//| fig-cap: "Complete FSA for binary strings ending with 00"
//| fig-width: 4.8
//| fig-height: 2
...
```{dot}
//| fig-cap: "Complete FSA for binary strings containing exactly three 0s"
//| fig-width: 6
//| fig-height: 2.1
