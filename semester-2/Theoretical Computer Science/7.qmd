...
##### **4.1. Build a DPDT for $L_1 = \{a^n b^m \mid n \geq 1 \wedge n \leq m\}$ Translating to $a^n b^n$** (Lab 6, Task 1)
...
##### **4.2. Build a DPDT for $L_2 = \{xc \mid x \in \{a,b\}^+\}$ Reversing the String** (Lab 6, Task 2)
...
##### **4.3. Build a DPDT for $L_1 = \{a^n b^m a^n \mid n \geq 1, m \geq 1\}$ Translating to $a^n b^m$** (Lab 6, Task 3)
...
##### **4.4. Build a DPDT for $L_2 = \{a^i b^j c^k \mid i+k = j\}$ Translating to $a^i b^i c^k$** (Lab 6, Task 4)
...
##### **4.5. Build a DPDT for $L_4 = \{a^n b^m \mid n \leq m \leq 2n\}$ Translating to $a^n b^n$** (Lab 6, Task 5)
