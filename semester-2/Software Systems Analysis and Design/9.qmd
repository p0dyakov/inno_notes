...
##### **3.1. Implement the Duck Lake Simulator** (Lecture 10, Exercise 1)
...
##### **3.2. Extend the Duck Simulator with DiveBehavior** (Lecture 10, Exercise 2)
...
##### **3.3. Implement the TurkeyAdapter Without Multiple Inheritance** (Lecture 10, Exercise 3)
...
##### **3.4. USB Card Reader Adapter** (Lecture 10, Example)
...
##### **3.5. Order Box Price Calculator** (Lecture 10, Example)
...
##### **3.6. Attack Game — Strategy Pattern** (Tutorial 10, Problem 1)
...
##### **3.7. Payment Gateway — Adapter Pattern** (Tutorial 10, Problem 2)
...
##### **3.8. File System — Composite Pattern** (Tutorial 10, Problem 3)
...
##### **3.9. Lecture Recap — Theory Questions** (Lab 9, Recap)
