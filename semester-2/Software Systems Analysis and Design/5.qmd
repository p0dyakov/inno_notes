...
##### **3.2. alignArray: Converting a Specific Function to a Template** (Lecture 5, Example 2)
...
##### **3.3. Stack Class Template with Non-type Size Parameter** (Lecture 5, Example 3)
...
##### **3.4. spaceOf: Explicit Function Template Instantiation** (Lecture 5, Example 4)
...
##### **3.5. RANGE Template: Complete Implementation** (Tutorial 5, Example 1)
...
##### **3.6. ARRAY Template with RANGE-based Boundaries** (Tutorial 5, Example 2)
...
##### **3.7. Generic Smart Pointer: RAII Implementation** (Tutorial 5, Example 3)
