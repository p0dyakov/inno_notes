---
title: "W4. Приведения типов C++, идентификация типа, удалённые и заданные по умолчанию функции, инициализация членов, делегирующие конструкторы, указатель this, константные методы"
