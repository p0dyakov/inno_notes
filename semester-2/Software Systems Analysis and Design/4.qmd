...
##### **3.10. Bank Account Class - Complete Implementation** (Lab 4, Task 1)
...
##### **3.11. Shape Hierarchy with Type Casting** (Lab 4, Task 2)
...
##### **3.1. Implementing a Non-Copyable Class** (Lecture 4, Example 1)
...
##### **3.2. Constructor Initializer Lists** (Lecture 4, Example 2)
...
##### **3.3. Delegating Constructors** (Lecture 4, Example 3)
...
##### **3.4. C-Style Casts: The Problem** (Tutorial 4, Example 1)
...
##### **3.5. Dynamic Cast in Action** (Tutorial 4, Example 2)
...
##### **3.6. Static Cast for Known-Safe Conversions** (Tutorial 4, Example 3)
...
##### **3.7. Const Cast for Const Correctness** (Tutorial 4, Example 4)
...
##### **3.8. Reinterpret Cast for Low-Level Operations** (Tutorial 4, Example 5)
...
##### **3.9. Using typeid for Type Identification** (Tutorial 4, Example 6)
