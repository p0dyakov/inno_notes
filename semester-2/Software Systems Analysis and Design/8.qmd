...
##### **3.4. Implement the Singleton Pattern in C#** (Lecture 9, Example 1)
...
##### **3.5. Implement the Singleton Pattern in C++** (Lecture 9, Example 2)
...
##### **3.6. Thread Safety in Singleton** (Lecture 9, Example 3–4)
...
##### **3.7. Lazy vs. Non-Lazy Singleton: Compare the Implementations** (Tutorial 9, Example 1)
...
##### **3.8. Prototype Pattern: Shapes Demo Trace** (Tutorial 9, Example 2)
...
##### **3.9. Builder Pattern: Car Factory Trace** (Tutorial 9, Example 3)
