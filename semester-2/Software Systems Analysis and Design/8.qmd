...
##### **3.5. Implement the Singleton Pattern in C++** (Lecture 8, Example 2)
...
##### **3.6. Thread Safety in Singleton** (Lecture 8, Example 3–4)
...
##### **3.7. Lazy vs. Non-Lazy Singleton: Compare the Implementations** (Lecture 8, Example 1)
...
##### **3.8. Prototype Pattern: Shapes Demo Trace** (Lecture 8, Example 2)
...
##### **3.9. Builder Pattern: Car Factory Trace** (Lecture 8, Example 3)
