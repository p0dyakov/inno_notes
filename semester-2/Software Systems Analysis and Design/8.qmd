...
##### **3.7. Lecture Recap: Design Patterns Review** (Lab 8, Task 1)
...
##### **3.8. Smart Document Editor** (Lab 8, Task 2)
...
##### **3.9. Document Builder** (Lab 8, Task 3)
...
##### **3.1. Implement the Singleton Pattern in C#** (Lecture 9, Example 1)
...
##### **3.2. Implement the Singleton Pattern in C++** (Lecture 9, Example 2)
...
##### **3.3. Thread Safety in Singleton** (Lecture 9, Example 3–4)
