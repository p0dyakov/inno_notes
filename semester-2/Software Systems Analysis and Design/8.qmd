...
##### **3.5. Lazy vs. Non-Lazy Singleton: Compare the Implementations** (Lecture 8, Example 1)
...
##### **3.6. Implement the Singleton Pattern in C++** (Lecture 8, Example 2)
...
##### **3.7. Prototype Pattern: Shapes Demo Trace** (Lecture 8, Example 2)
...
##### **3.8. Builder Pattern: Car Factory Trace** (Lecture 8, Example 3)
...
##### **3.9. Thread Safety in Singleton** (Lecture 8, Example 3–4)
