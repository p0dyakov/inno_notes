...
##### **3.6. Finding Value in Array (Version 1)** (Tutorial 1, Example)
...
##### **3.7. Finding Value in Array (Version 2)** (Tutorial 1, Example)
...
##### **3.8. Vector Element Modification** (Tutorial 1, Example)
...
##### **3.9. Structured Binding with Arrays** (Tutorial 1, Example)
...
##### **3.10. Structured Binding with Structs** (Tutorial 1, Example)
...
##### **3.11. Auto Type Deduction** (Lecture 1, Examples)
...
##### **3.12. Reference Examples** (Lecture 1, Examples)
...
##### **3.13. Pointers and Constants** (Lecture 1, Example)
