...
##### **3.9. Standard Conversion and Its Prevention** (Lab 6, Task 1)
...
##### **3.10. Create a Wrapper Class Template with Explicit Specialization** (Lab 6, Task 2)
...
##### **3.11. Implement a Dictionary Class Template with Partial Specialization** (Lab 6, Task 3)
...
##### **3.12. Implement Custom Map and Filter with Lambdas** (Lab 6, Task 4)
...
##### **3.6. Fibonacci Numbers with Explicit Specializations** (Lecture 6, Example 6)
...
##### **3.7. Functional Objects: Generic Find** (Tutorial 6, Example 1)
...
##### **3.8. Lambda Closures: Capture by Value vs. Reference** (Tutorial 6, Example 2)
