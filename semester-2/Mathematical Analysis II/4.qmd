...
$$\nabla\times\mathbf{F}
=\left(\frac{2}{x+2y}-\frac{3}{x+3z}\right)\mathbf{i}
+\left(\frac{3}{2y+3z}-\frac{1}{x+2y}\right)\mathbf{j}
+\left(\frac{1}{x+3z}-\frac{2}{2y+3z}\right)\mathbf{k}.$$
...
$$\nabla\times\mathbf{F}
=-\frac{y}{1+y^2z^2}\mathbf{i}
-\frac{z}{1+x^2z^2}\mathbf{j}
-\frac{x}{1+x^2y^2}\mathbf{k}.$$

For the divergence,

$$P_x=\frac{y}{1+x^2y^2},\qquad
Q_y=\frac{z}{1+y^2z^2},\qquad
R_z=\frac{x}{1+x^2z^2}.$$

Therefore

$$\nabla\cdot\mathbf{F}
=\frac{y}{1+x^2y^2}+\frac{z}{1+y^2z^2}+\frac{x}{1+x^2z^2}.$$
...
$$\int_{C_3}\mathbf{F}\cdot d\mathbf{r}
=\int_0^1(3t^2-3t)\,dt
=-\frac12.$$
...
$$\int_0^2x\sqrt{1+4x^2}\,dx
=\frac18\int_1^{17}u^{1/2}\,du
...
$$\text{Flux}
=\int_0^{\pi/2}\int_0^{\pi/2}\frac{a^2\cos^2\phi}{a}\cdot a^2\sin\phi\,d\phi\,d\theta.$$
...
$$\int_0^{\pi/2}d\theta=\frac{\pi}{2},\qquad
\int_0^{\pi/2}\cos^2\phi\sin\phi\,d\phi=\frac13.$$
...
$$\text{circulation}
=\int_0^{\pi/2}\int_0^{\pi/2}2\cos y\,dx\,dy
=\frac{\pi}{2}\cdot2\int_0^{\pi/2}\cos y\,dy
=\pi.$$
...
$$\text{flux}
=\int_0^{\pi/2}\int_0^{\pi/2}-x\sin y\,dx\,dy.$$

Separate the variables:

$$\text{flux}
=-\left(\int_0^{\pi/2}x\,dx\right)\left(\int_0^{\pi/2}\sin y\,dy\right)
=-\frac{\pi^2}{8}\cdot1
=-\frac{\pi^2}{8}.$$
...
$$\mathbf{F}\cdot\langle1,1,1\rangle
=2xy+2y(2a-x-y)+2x(2a-x-y).$$

Simplify:

$$2xy+4ay-2xy-2y^2+4ax-2x^2-2xy
=4a(x+y)-2x^2-2y^2-2xy.$$
...
$$\iint 2x^2\,dA=\frac{2a^4}{3},\qquad
\iint 2y^2\,dA=\frac{2a^4}{3},$$
...
$$\text{Flux}=4a^4-\frac{2a^4}{3}-\frac{2a^4}{3}-\frac{a^4}{2}
=\frac{13a^4}{6}.$$
...
##### **4.60. Interpret Basic Vector Fields** (Chapter 4, Example)
...
##### **4.82. Parametrize a Plane, Cone, and Sphere** (Chapter 4, Example 15-17)
