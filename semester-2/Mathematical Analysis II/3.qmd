...
##### **4.1. Converting Between Polar and Cartesian Coordinates** (Chapter 3, Example 1)
...
##### **4.2. Converting a Polar Equation to Cartesian Form** (Chapter 3, Example 2)
...
##### **4.3. Converting an Ellipse to Polar Form** (Chapter 3, Example 3)
...
##### **4.4. Parametric Equations for a Line in Space** (Chapter 3, Example 4)
...
##### **4.5. Equation of a Plane Through Three Points** (Chapter 3, Example 5)
...
##### **4.6. Classifying a Quadric Surface** (Chapter 3, Example 6)
...
##### **4.7. Double Integral Over a Rectangle** (Chapter 3, Example 7)
...
##### **4.8. Volume Under an Elliptical Paraboloid** (Chapter 3, Example 8)
...
##### **4.9. Reversing the Order of Integration** (Chapter 3, Example 9)
...
##### **4.10. Volume of a Tetrahedron** (Chapter 3, Example 10)
...
##### **4.11. Volume Under a Paraboloid Over a Circular Region** (Chapter 3, Example 11)
...
##### **4.12. Change of Variables: Hyperbolic Region** (Chapter 3, Example 12)
...
##### **4.13. Change of Variables: Linear Transformation** (Chapter 3, Example 13)
...
##### **4.14. Polar Coordinates: Semicircle** (Chapter 3, Example 14)
...
##### **4.15. Area of a Lemniscate** (Chapter 3, Example 15)
...
##### **4.16. Area Between a Cardioid and Circle** (Chapter 3, Example 16)
...
##### **4.17. Improper Double Integral** (Chapter 3, Example 17)
...
##### **4.18. The Gaussian Integral** (Chapter 3, Example 18)
...
##### **4.19. Average Value of a Triple Integral** (Chapter 3, Example 19)
...
##### **4.20. Volume Between Two Paraboloids** (Chapter 3, Example 20)
...
##### **4.21. Triple Integral by General Transformation** (Chapter 3, Example 21)
...
##### **4.22. Triple Integral in Cylindrical Coordinates** (Chapter 3, Example 22)
...
##### **4.23. Volume of an Ice Cream Cone in Spherical Coordinates** (Chapter 3, Example 23)
...
##### **4.34. Plane Parallel to a Given Plane** (Chapter 3, Example 24)
...
##### **4.35. Plane Perpendicular to Another Plane** (Chapter 3, Example 25)
...
##### **4.49. Improper Double Integral with Exponential** (Chapter 3, Example 26)
...
##### **4.50. Improper Double Integral with Singularity** (Chapter 3, Example 27)
...
##### **4.24. Convert to Cartesian Polar Coordinates** (Chapter 3, Exercise 1)
...
##### **4.25. Reduce to Standard Form and Classify Quadric Surfaces** (Chapter 3, Exercise 2)
...
##### **4.26. Double Integrals Over a Rectangle** (Chapter 3, Exercise 3)
...
##### **4.27. Volume Under a Plane** (Chapter 3, Exercise 4)
...
##### **4.28. Reversing Order of Integration** (Chapter 3, Exercise 5)
...
##### **4.29. Change of Variables: Polar, Linear** (Chapter 3, Exercise 6)
...
##### **4.30. Area of an Ellipse** (Chapter 3, Exercise 7)
...
##### **4.31. Triple Integrals by Switching Order** (Chapter 3, Exercise 8)
...
##### **4.32. Volume in Cylindrical Coordinates** (Chapter 3, Exercise 9)
...
##### **4.33. Volume in Spherical Coordinates** (Chapter 3, Exercise 10)
...
##### **4.36. Classify Quadric Surfaces (continued)** (Chapter 3, Exercise 11)
...
##### **4.37. Remaining Rectangle Integrals** (Chapter 3, Exercise 12)
...
##### **4.38. Volume Under a Trigonometric Surface** (Chapter 3, Exercise 13)
...
##### **4.39. Finding a Constant from a Definite Integral** (Chapter 3, Exercise 14)
...
##### **4.40. More Integrals by Switching Order** (Chapter 3, Exercise 15)
...
##### **4.41. Double Integral Over a Diamond Region** (Chapter 3, Exercise 16)
...
##### **4.42. Double Integral Over a Disk** (Chapter 3, Exercise 17)
...
##### **4.43. Double Integral in the First Quadrant** (Chapter 3, Exercise 18)
...
##### **4.44. Double Integral with Square Root** (Chapter 3, Exercise 19)
...
##### **4.45. Volumes of Two Solids** (Chapter 3, Exercise 20)
...
##### **4.46. Volume Inside a Cylinder Using Polar Coordinates** (Chapter 3, Exercise 21)
...
##### **4.47. More Change of Variables Exercises** (Chapter 3, Exercise 22)
...
##### **4.48. Integral Over an Ellipse** (Chapter 3, Exercise 23)
...
##### **4.51. Triple Integral Over a Paraboloid Region** (Chapter 3, Exercise 24)
...
##### **4.52. Volume of a Solid Bounded by Planes** (Chapter 3, Exercise 25)
...
##### **4.53. Volume of an Elliptical Cylinder Solid** (Chapter 3, Exercise 26)
...
##### **4.54. Triple Integral in Cylindrical Coordinates (Second Integral)** (Chapter 3, Exercise 27)
...
##### **4.55. Volume Between Sphere and Cylinder** (Chapter 3, Exercise 28)
...
##### **4.56. Triple Integral by Linear Substitution** (Chapter 3, Exercise 29)
...
##### **4.57. Second Spherical Coordinates Exercise** (Chapter 3, Exercise 30)
