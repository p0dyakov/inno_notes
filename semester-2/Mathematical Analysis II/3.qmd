...
##### **4.1. Converting Between Polar and Cartesian Coordinates** (Lecture 3, Example 1)
...
##### **4.2. Converting a Polar Equation to Cartesian Form** (Lecture 3, Example 3)
...
##### **4.3. Converting an Ellipse to Polar Form** (Lecture 3, Example 4)
...
##### **4.4. Parametric Equations for a Line in Space** (Lecture 3, Example — Lines)
...
##### **4.5. Equation of a Plane Through Three Points** (Lecture 3, Example 1 — Planes)
...
##### **4.6. Classifying a Quadric Surface** (Lecture 3, Example — Quadrics)
...
##### **4.7. Double Integral Over a Rectangle** (Lecture 3, Example 1 — Rect. Integrals)
...
##### **4.8. Volume Under an Elliptical Paraboloid** (Lecture 3, Example 2 — Rect. Integrals)
...
##### **4.9. Reversing the Order of Integration** (Lecture 3, Example — General Regions)
...
##### **4.10. Volume of a Tetrahedron** (Lecture 3, Example 1 — General Regions)
...
##### **4.11. Volume Under a Paraboloid Over a Circular Region** (Lecture 3, Example 3 — General Regions)
...
##### **4.12. Change of Variables: Hyperbolic Region** (Lecture 3, Example 1 — Change of Variables)
...
##### **4.13. Change of Variables: Linear Transformation** (Lecture 3, Example 2 — Change of Variables)
...
##### **4.14. Polar Coordinates: Semicircle** (Lecture 3, Example 1 — Polar)
...
##### **4.15. Area of a Lemniscate** (Lecture 3, Example 2 — Polar Area)
...
##### **4.16. Area Between a Cardioid and Circle** (Lecture 3, Example 3 — Polar Area)
...
##### **4.17. Improper Double Integral** (Lecture 3, Example 1 — Unbounded)
...
##### **4.18. The Gaussian Integral** (Lecture 3, Example — Gaussian Integral)
...
##### **4.19. Average Value of a Triple Integral** (Lecture 3, Example — Triple Integrals)
...
##### **4.20. Volume Between Two Paraboloids** (Lecture 3, Example 1 — Triple Integrals over General Regions)
...
##### **4.21. Triple Integral by General Transformation** (Lecture 3, Example — Triple Change of Variables)
...
##### **4.22. Triple Integral in Cylindrical Coordinates** (Lecture 3, Example 1 — Cylindrical)
...
##### **4.23. Volume of an Ice Cream Cone in Spherical Coordinates** (Lecture 3, Example 2 — Spherical)
...
##### **4.24. Convert to Cartesian Polar Coordinates** (Lecture 3, Exercises — Polar Coordinates)
...
##### **4.25. Reduce to Standard Form and Classify Quadric Surfaces** (Lecture 3, Exercises — Quadrics)
...
##### **4.26. Double Integrals Over a Rectangle** (Lecture 3, Exercises 1 — Rectangle Integrals)
...
##### **4.27. Volume Under a Plane** (Lecture 3, Exercise 2 — Rectangle Volumes)
...
##### **4.28. Reversing Order of Integration** (Lecture 3, Exercise 1 — General Regions)
...
##### **4.29. Change of Variables: Polar, Linear** (Lecture 3, Exercise 1 — Change of Variables)
...
##### **4.30. Area of an Ellipse** (Lecture 3, Exercise 6 — Change of Variables)
...
##### **4.31. Triple Integrals by Switching Order** (Lecture 3, Exercise 1 — Triple Integrals)
...
##### **4.32. Volume in Cylindrical Coordinates** (Lecture 3, Exercise 2 — Cylindrical)
...
##### **4.33. Volume in Spherical Coordinates** (Lecture 3, Exercise 5 — Spherical)
...
##### **4.34. Plane Parallel to a Given Plane** (Lecture 3, Example 2 — Planes)
...
##### **4.35. Plane Perpendicular to Another Plane** (Lecture 3, Example 3 — Planes)
...
##### **4.36. Classify Quadric Surfaces (continued)** (Lecture 3, Exercises — Quadrics)
...
##### **4.37. Remaining Rectangle Integrals** (Lecture 3, Exercise 1 — Rectangle Integrals)
...
##### **4.38. Volume Under a Trigonometric Surface** (Lecture 3, Exercise 3 — Rectangle Volumes)
...
##### **4.39. Finding a Constant from a Definite Integral** (Lecture 3, Exercise 4 — Rectangle Integrals)
...
##### **4.40. More Integrals by Switching Order** (Lecture 3, Exercise 1 — General Regions)
...
##### **4.41. Double Integral Over a Diamond Region** (Lecture 3, Exercise 3 — General Regions)
...
##### **4.42. Double Integral Over a Disk** (Lecture 3, Exercise 4 — General Regions)
...
##### **4.43. Double Integral in the First Quadrant** (Lecture 3, Exercise 5 — General Regions)
...
##### **4.44. Double Integral with Square Root** (Lecture 3, Exercise 6 — General Regions)
...
##### **4.45. Volumes of Two Solids** (Lecture 3, Exercise 7 — General Regions)
...
##### **4.46. Volume Inside a Cylinder Using Polar Coordinates** (Lecture 3, Exercise 8 — General Regions)
...
##### **4.47. More Change of Variables Exercises** (Lecture 3, Exercises — Change of Variables)
...
##### **4.48. Integral Over an Ellipse** (Lecture 3, Exercise 5 — Change of Variables)
...
##### **4.49. Improper Double Integral with Exponential** (Lecture 3, Example 2 — Unbounded)
...
##### **4.50. Improper Double Integral with Singularity** (Lecture 3, Example 3 — Unbounded)
...
##### **4.51. Triple Integral Over a Paraboloid Region** (Lecture 3, Exercise 2 — Triple Integrals)
...
##### **4.52. Volume of a Solid Bounded by Planes** (Lecture 3, Exercise 3 — Triple Integrals)
...
##### **4.53. Volume of an Elliptical Cylinder Solid** (Lecture 3, Exercise 4 — Triple Integrals)
...
##### **4.54. Triple Integral in Cylindrical Coordinates (Second Integral)** (Lecture 3, Exercise 1 — Cylindrical)
...
##### **4.55. Volume Between Sphere and Cylinder** (Lecture 3, Exercise 3 — Cylindrical)
...
##### **4.56. Triple Integral by Linear Substitution** (Lecture 3, Exercise 4 — Cylindrical/General)
...
##### **4.57. Second Spherical Coordinates Exercise** (Lecture 3, Exercise 5b — Spherical)
...
##### **4.58. Find and Classify Critical Points** (Lab 9, Problem 1)
...
##### **4.59. Maximum Volume of a Lidless Box** (Lab 9, Problem 2)
...
##### **4.60. Extreme Values on a Circle** (Lab 9, Problem 3)
...
##### **4.61. Points on a Sphere Closest/Farthest from a Point** (Lab 9, Problem 4)
...
##### **4.62. Maximum and Minimum of $xy$ on the Unit Circle** (Lab 9, Problem 5)
...
##### **4.63. Second Degree Taylor Polynomial at $(0,0)$** (Lab 9, Problem 6)
...
##### **4.64. Second Degree Taylor Polynomial at $(1,2)$** (Lab 9, Problem 7)
...
##### **4.65. Estimate Using Second Degree Taylor Polynomial** (Lab 9, Problem 8)
