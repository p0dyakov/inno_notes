...
#### **4. Examples**
##### **4.1. Evaluate a Limit by Direct Substitution** (Lecture 2, Example 1)
...
##### **4.2. Evaluate a Limit Using the Product Rule** (Lecture 2, Example 2)
...
##### **4.3. Evaluate a Limit by Direct Substitution (3 Variables)** (Lecture 2, Example 3)
...
##### **4.4. Evaluate a Limit Using Factoring** (Lecture 2, Example 4)
...
##### **4.5. Evaluate a Limit by Rationalizing** (Lecture 2, Example 5)
...
##### **4.6. Show a Limit Does Not Exist (Two-Path Test)** (Lecture 2, Example 6)
...
##### **4.7. Show a Limit Does Not Exist (Parabola Paths)** (Lecture 2, Example 7)
...
##### **4.8. Compute Partial Derivatives** (Lecture 2, Example 1 — Partial Derivatives)
...
##### **4.9. Partial Derivatives of a Composite Function** (Lecture 2, Example 3 — Partial Derivatives)
...
##### **4.10. Implicit Differentiation: One Equation** (Lecture 2, Example 1 — Implicit)
...
##### **4.11. Implicit Differentiation: Three Variables** (Lecture 2, Example 2 — Implicit)
...
##### **4.12. Chain Rule with One Parameter** (Lecture 2, Example 3 — Chain Rule)
...
##### **4.13. Chain Rule with Two Parameters** (Lecture 2, Example 4 — Chain Rule)
...
##### **4.14. Directional Derivative via Gradient** (Lecture 2, Example — Directional Derivative)
...
##### **4.15. Classify Critical Points** (Lecture 2, Example 1 — Extrema)
...
##### **4.16. Constrained Optimization by Substitution** (Lecture 2, Example — Constrained)
...
##### **4.17. Lagrange Multipliers — One Constraint** (Lecture 2, Example 1 — Lagrange)
...
##### **4.18. Lagrange Multipliers — Two Constraints** (Lecture 2, Example 2 — Lagrange)
...
##### **4.19. Taylor Quadratic Approximation** (Lecture 2, Example — Taylor)
...
##### **4.20. Lecture Exercises — Chain Rule** (Lecture 2, Exercise 1 — Chain Rule)
...
##### **4.21. Lecture Exercises — Implicit Differentiation** (Lecture 2, Exercise 3 — Chain Rule)
...
##### **4.22. Lecture Exercises — Gradient** (Lecture 2, Exercise 1 — Directional Derivatives)
...
##### **4.23. Lecture Exercises — Directional Derivative** (Lecture 2, Exercise 2 — Directional Derivatives)
...
$$f_x = \frac{(xy+2)-(x-y)y}{(xy+2)^2}\bigg|_{(1,-1)} = \frac{1+1\cdot(-1)-(1-(-1))(-1)}{1} = \frac{1-(- 2)}{1} = \frac{1+2}{1} = 3.$$

Wait, let me redo carefully: $f_x = \frac{1\cdot(xy+2)-(x-y)\cdot y}{(xy+2)^2}$. At $(1,-1)$: $= \frac{1-(2)(-1)}{1} = \frac{1+2}{1} = 3$.
...
##### **4.24. Lecture Exercises — Max/Min Directions** (Lecture 2, Exercise 3 — Directional Derivatives)
...
##### **4.25. Lecture Exercises — Lagrange Multipliers** (Lecture 2, Exercise 1 — Lagrange)
...
##### **4.26. Lecture Exercises — Taylor Approximations** (Lecture 2, Exercise 1 — Taylor)
...
##### **4.27. Find and Sketch the Domain** (Lab 6, Problem 1)
...
##### **4.28. Sketch Level Curves** (Lab 6, Problem 2)
...
##### **4.29. Find Limits** (Lab 6, Problem 3)
...
##### **4.30. Show No Limit Exists** (Lab 6, Problem 4)
...
##### **4.31. Define $f(0,0)$ for Continuity** (Lab 6, Problem 5)
...
##### **4.32. Domain Homework** (Lab 6, Homework Problem 1)
...
##### **4.33. Level Curves Homework** (Lab 6, Homework Problem 2)
...
##### **4.34. More Limit Problems — Homework** (Lab 6, Homework Problem 3)
...
##### **4.35. Show No Limit Exists — Homework** (Lab 6, Homework Problem 4)
...
##### **4.36. Test Continuity — Homework** (Lab 6, Homework Problem 5)
...
##### **4.37. Evaluate Limits** (Lab 7, Task 1.1)
...
##### **4.38. Evaluate a Limit via Squeeze** (Lab 7, Task 1.2)
...
##### **4.39. Existence of Limit — Three Variables** (Lab 7, Task 1.3)
...
##### **4.40. Limit of Three-Variable Function at a Point** (Lab 7, Task 1.4)
...
##### **4.41. Compute Partial Derivatives** (Lab 7, Task 2.1)
...
##### **4.42. Partial Derivatives with Composite Terms** (Lab 7, Task 2.2)
...
##### **4.43. Partial Derivatives of a Power Function** (Lab 7, Task 2.3)
...
##### **4.44. Check Harmonic Functions** (Lab 7, Task 2.4)
...
##### **4.45. Chain Rule: $dz/dt$** (Lab 7, Task 2.5)
...
##### **4.46. Chain Rule: Three-Variable Composition** (Lab 7, Task 2.6)
...
##### **4.47. Implicit Differentiation: $dy/dx$** (Lab 7, Task 2.7)
...
##### **4.48. Implicit Differentiation: $z_x$, $z_y$** (Lab 7, Task 2.8)
...
##### **4.49. Directional Derivative (Slope Toward a Point)** (Lab 7, Task 2.9)
...
##### **4.50. Directional Derivatives — Lab 8 Exercises** (Lab 8, Exercise 1)
...
##### **4.51. Directional Derivative of $\cos(x/y)$** (Lab 8, Exercise 2)
...
$D_\mathbf{u}f = \dfrac{-3\sin(x/y)}{5y} + \dfrac{-4x\sin(x/y)}{5y^2}\cdot(-1) = -\dfrac{(3y+4x)\sin(x/y)}{5y^2}$.

Wait: $f_y = \dfrac{x\sin(x/y)}{y^2}$, and $u_y = -4/5$:
...
##### **4.52. Directional Derivative at an Angle** (Lab 8, Exercise 3)
...
##### **4.53. Find Functions from Partial Derivatives** (Lab 8, Exercise 4)
...
##### **4.54. Find and Classify Critical Points** (Lab 8, Exercise 5)
...
##### **4.55. Directional Derivative — Lab 8 Homework** (Lab 8, Homework Problem 1)
...
##### **4.56. Classify Critical Points — Lab 8 Homework** (Lab 8, Homework Problem 2)
