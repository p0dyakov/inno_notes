...
##### **4.1. Determine Whether Pairs of Matrices Are Similar** (Assignment 7, Task 1.1)
...
##### **4.2. Prove Invariants of Similar Matrices** (Assignment 7, Task 1.2)
...
##### **4.3. Diagonalize a $3 \times 3$ Matrix** (Assignment 7, Task 1.3)
...
##### **4.4. Compute $A^{10}$ Using Diagonalization** (Assignment 7, Task 1.4)
...
##### **4.5. Find All Eigenvalues and Eigenvectors** (Assignment 7, Task 2.1)
...
##### **4.6. True or False: Properties of Eigenvalues** (Assignment 7, Task 2.2)
...
##### **4.7. Eigenvectors of Matrix Powers and Polynomials** (Assignment 7, Task 2.3)
...
##### **4.8. Using the Eigendecomposition to Compute $A\mathbf{u}$** (Assignment 7, Task 2.4)
...
##### **4.9. Operations on Complex Vectors** (Assignment 7, Task 3.1)
...
##### **4.10. Eigenvalues of Complex Matrices** (Assignment 7, Task 3.2)
...
##### **4.11. Diagonalizability Over $\mathbb{R}$ vs. $\mathbb{C}$** (Assignment 7, Task 3.3)
...
##### **4.12. Unitary Matrices: Columns, Norm Preservation, Eigenvalues** (Assignment 7, Task 3.4)
...
##### **4.13. Conjugate Transpose and Hermitian Matrices** (Assignment 7, Task 3.5)
...
##### **4.14. Determine Diagonalizability** (Assignment 7, Task 4.1)
...
##### **4.15. State and Prove the Diagonalization Theorem** (Assignment 7, Task 4.2)
...
##### **4.16. Compute $A^5$ Using Diagonalization** (Assignment 7, Task 4.3)
...
##### **4.17. Orthogonal Diagonalization of a Symmetric Matrix** (Assignment 7, Task 4.4)
...
##### **4.18. Constructing Matrices with Given Spectral Properties** (Assignment 7, Task 4.5)
...
##### **4.19. Polynomial of a Diagonalizable Matrix** (Assignment 7, Task 4.6)
...
##### **4.20. Simultaneous Diagonalization** (Assignment 7, Task 5.1)
...
##### **4.21. Spectral Decomposition** (Assignment 7, Task 5.2)
...
##### **4.22. The Cayley-Hamilton Theorem** (Assignment 7, Task 5.3)
...
##### **4.23. Complex Vector Operations** (Lecture 8, Example 1)
...
##### **4.24. Norm of a Complex Vector** (Lecture 8, Example 2)
...
##### **4.25. Verify a Unitary Matrix and Find Its Eigenvalues** (Lecture 8, Example 3)
...
##### **4.26. Operations on Complex Numbers** (Lecture 8, Task 1)
...
##### **4.27. Properties of a Complex Number and Its Conjugate** (Lecture 8, Task 2)
...
##### **4.28. Norms and Inner Product of Complex Vectors** (Lecture 8, Task 3)
...
##### **4.29. Classify a Matrix and Compute Its Powers** (Lecture 8, Task 4)
...
##### **4.30. Prove a Formula for Matrix Powers Using Diagonalization** (Lecture 8, Task 5)
...
##### **4.31. Reconstruct a Matrix from Trace and Determinant Conditions** (Lecture 8, Task 6)
...
##### **4.32. Reconstruct a Matrix from Its Eigendecomposition** (Lecture 8, Task 7)
...
##### **4.33. Complex Numbers in Polar Form** (Lecture 8, Task 8)
...
##### **4.34. Compute $A^H$ and Verify Hermitian Property** (Lecture 8, Task 9)
...
##### **4.35. Null Space and Complex Orthogonality** (Lecture 8, Task 10)
...
##### **4.36. Show Matrices Are Similar** (Lecture 8, Task 11)
...
##### **4.37. Orthonormal Basis and Projection Matrix** (Midterm Recap, Task 1)
...
##### **4.38. Least Squares Line Fitting** (Midterm Recap, Task 2)
...
##### **4.39. Solving a Linear System with Free Variables** (Midterm Recap, Task 3)
...
##### **4.40. Eigenvalues and Eigenvectors of a Tridiagonal Matrix** (Midterm Recap, Task 4)
...
##### **4.41. Fundamental Subspaces of a Rank-1 Matrix** (Midterm Recap, Task 5)
...
##### **4.42. Complex Matrix and Hermitian Conjugate** (Midterm Recap, Task 6)
...
##### **4.43. Inhomogeneous System and Null Space** (Midterm Recap, Task 7)
...
##### **4.44. Four Fundamental Subspaces** (Midterm 2026, Task 1)
...
##### **4.45. Least-Squares Line via Normal Equations** (Midterm 2026, Task 2)
...
##### **4.46. Eigenvalues, Eigenvectors, and Matrix Power** (Midterm 2026, Task 3)
...
##### **4.47. Solving a Linear System** (Midterm 2026, Task 4)
...
##### **4.48. Projection Matrix and Projection of a Vector** (Midterm 2026, Task 5)
...
##### **4.49. Complex Matrix: Null Space and Orthogonality** (Midterm 2026, Task 6)
