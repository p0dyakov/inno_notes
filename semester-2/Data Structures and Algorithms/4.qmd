...
##### **4.6. Compare Sorting Algorithms on Different Data** (Lecture 4, Task 1)
...
##### **4.7. Estimate Complexity of Radix Sort with Arbitrary Radix** (Lecture 4, Task 2)
...
##### **4.8. Time Complexity of Radix Sort with Variable-Radix** (Lecture 4, Task 3)
...
##### **4.9. Range Queries Using Counting Sort** (Lecture 4, Task 4)
...
##### **4.10. Apply Counting Sort** (Problem Set 4, Task 1)
...
##### **4.11. Radix Sort Complexity for Programs** (Problem Set 4, Task 2)
...
##### **4.12. Decision Tree for Quicksort Variation** (Problem Set 4, Task 3)
