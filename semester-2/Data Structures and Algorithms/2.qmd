...
#### **4. Examples**
##### **4.1. Factorial (Recursive)** (Lecture 2, Example 1)
...
##### **4.2. Fibonacci (Recursive)** (Lecture 2, Example 2)
...
##### **4.3. Binary Search (Recursive)** (Lecture 2, Example 3)
...
##### **4.4. N Queens Problem (Backtracking)** (Lecture 2, Example 4)
...
##### **4.5. Reverse a Doubly Linked List in $O(n)$** (Problem Set 2, Problem 1.1)
...
##### **4.6. Reverse an ArrayList** (Problem Set 2, Problem 1.2)
...
##### **4.7. Reverse a Singly Linked List without Tail Pointer** (Problem Set 2, Problem 1.3)
...
##### **4.8. Reverse a Singly Linked List with Tail Pointer** (Problem Set 2, Problem 1.4)
...
##### **4.9. Reverse an ArrayStack** (Problem Set 2, Problem 1.5)
...
##### **4.10. Reverse a LinkedStack** (Problem Set 2, Problem 1.6)
...
##### **4.11. Reverse an ArrayQueue** (Problem Set 2, Problem 1.7)
...
##### **4.12. Reverse a LinkedQueue** (Problem Set 2, Problem 1.8)
...
##### **4.13. Queue Using Two Stacks** (Problem Set 2, Problem 2)
...
##### **4.14. Counting Subsets with a Given Sum (Brute Force)** (Problem Set 2, Problem 3)
