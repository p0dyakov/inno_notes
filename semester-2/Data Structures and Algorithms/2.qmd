...
##### **4.5. Reverse a Doubly Linked List in $O(n)$** (Problem Set 2, Task 1.1)
...
##### **4.6. Reverse an ArrayList** (Problem Set 2, Task 1.2)
...
##### **4.7. Reverse a Singly Linked List without Tail Pointer** (Problem Set 2, Task 1.3)
...
##### **4.8. Reverse a Singly Linked List with Tail Pointer** (Problem Set 2, Task 1.4)
...
##### **4.9. Reverse an ArrayStack** (Problem Set 2, Task 1.5)
...
##### **4.10. Reverse a LinkedStack** (Problem Set 2, Task 1.6)
...
##### **4.11. Reverse an ArrayQueue** (Problem Set 2, Task 1.7)
...
##### **4.12. Reverse a LinkedQueue** (Problem Set 2, Task 1.8)
...
##### **4.13. Queue Using Two Stacks** (Problem Set 2, Task 2)
...
##### **4.14. Counting Subsets with a Given Sum (Brute Force)** (Problem Set 2, Task 3)
