...
#### **4. Examples**
##### **4.1. Prove $2^{n+1} = O(2^n)$** (Lecture 1, Task 1)
...
##### **4.3. Prove $\max(f(n), g(n)) = \Theta(f(n) + g(n))$** (Lecture 1, Task 3)
...
##### **4.4. Prove $(n + a)^b = \Theta(n^b)$** (Lecture 1, Task 4)
...
##### **4.5. Prove Product Rule for $O$-notation** (Lecture 1, Task 5)
...
##### **4.6. Prove that $k \ln k = \Theta(n)$ implies $k = \Theta(n / \ln n)$** (Lecture 1, Task 6)
...
##### **4.8. Prove Correctness and Analyze exp1 Algorithm** (Lab 1, Task 1)
...
##### **4.9. Prove Correctness and Analyze exp2 Algorithm** (Lab 1, Task 2)
...
##### **4.10. GCD Algorithm (Naive)** (Lab 1, Task 3)
...
##### **4.11. Euclidean GCD Algorithm** (Lab 1, Task 4)
...
##### **4.12. Compute Asymptotic Worst-Case Time Complexity** (Problem Set 1, Task 1)
...
##### **4.13. Loop Invariant Proof for Reorder Algorithm** (Problem Set 1, Task 2)
...
##### **4.14. Asymptotic Notation: True or False** (Problem Set 1, Task 3)
