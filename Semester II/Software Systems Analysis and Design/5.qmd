---
title: "W5. C++ Templates, RANGE Metaprogramming, Smart Pointers"
...
##### **3.1. Max Function Template: Find the Maximum of Two Values** (Lecture 5, Example 1)
...
##### **3.2. alignArray: Converting a Specific Function to a Template** (Lecture 5, Exercise 1)
...
##### **3.3. Stack Class Template with Non-type Size Parameter** (Lecture 5, Example 2)
...
##### **3.4. spaceOf: Explicit Function Template Instantiation** (Lecture 5, Example 3)
...
##### **3.5. RANGE Template: Complete Implementation** (Tutorial 5, Exercise 1)
...
##### **3.6. ARRAY Template with RANGE-based Boundaries** (Tutorial 5, Exercise 2)
...
##### **3.7. Generic Smart Pointer: RAII Implementation** (Tutorial 5, Problem 1)
...
##### **3.8. Generic Stack with Specialized StringStack** (Lab 5, Task 1)
...
##### **3.9. Smart Pointers in Practice: Box Class** (Lab 5, Task 2)
