...
digraph PDT_arch {
  rankdir=TB;
  bgcolor="transparent";
  node [fontname="Helvetica", fontsize=11, shape=box, style=filled, fillcolor="#e8f4f8"];
  edge [fontname="Helvetica", fontsize=10];

  input  [label="Input tape\n← read-only →", shape=box];
  ctrl   [label="Finite state\ncontrol", shape=ellipse, fillcolor="#ffeaa7"];
  stack  [label="Stack\n(LIFO)", shape=box];
  output [label="Output tape\n← write-only →", shape=box];
...
digraph PDT_anbn_AaBb {
  ...
  nodesep=0.25;
  ranksep=0.35;
  node [fontname="Helvetica", fontsize=10, margin="0.05,0.03", height=0.28];
...
digraph PDT_reverse {
  ...
  nodesep=0.35;
  ranksep=0.5;
  node [fontname="Helvetica", fontsize=10, margin="0.06,0.03", height=0.3];
  edge [fontname="Helvetica", fontsize=9];

  start [shape=point, width=0.12];
  q0 [shape=circle, label="q₀ (PUSH)"];
  q1 [shape=circle, label="q₁ (POP)"];
  q2 [shape=doublecircle, label="q₂"];
...
digraph closure_overview {
  ...
  bgcolor="transparent";
  ranksep=0.4;
  node [fontname="Helvetica", fontsize=10, shape=box, style=filled, margin="0.08,0.04", height=0.35];
  edge [fontname="Helvetica", fontsize=9];

  FSA  [label="FSA: ∪✓ ∩✓ \\✓ ᶜ✓", fillcolor="#c8e6c9"];
  DPDA [label="DPDA: ∪✗ ∩✗ \\✗ ᶜ✓", fillcolor="#ffcdd2"];
...
##### **4.1. FST — Translating All Strings Over $\{a,b\}$** (Tutorial 7, Example 1)
...
##### **4.2. FST — Translating Only Strings Without $b$'s** (Tutorial 7, Example 2)
...
##### **4.3. PDT — Translating $a^n b^n \to A^n B^n$** (Tutorial 7, Example 3)
...
##### **4.4. PDT — Translating $a^n b^n \to b^n$** (Tutorial 7, Example 4)
...
##### **4.5. PDT — Translating $a^n b^n \to b^n a^n$** (Tutorial 7, Example 5)
...
##### **4.6. DPDA Closure Under Union — Counterexample** (Lecture 7, Example 3)
...
##### **4.7. DPDA — Constructing the DPDA for $L_1 = \{a^n b^n c^m \mid n, m > 0\}$** (Tutorial 7, Example 6)
...
##### **4.8. DPDA — Constructing the DPDA for $L_2 = \{a^m b^n c^n \mid n, m > 0\}$** (Tutorial 7, Example 7)
...
##### **4.9. DPDA Closure Under Intersection — Counterexample** (Tutorial 7, Example 8)
...
##### **4.10. DPDA Closure Under Complement — Construction Idea** (Lecture 7, Example 1)
...
##### **4.11. DPDA Closure Under Difference — Proof by Contradiction** (Lecture 7, Example 2)
...
##### **4.12. Build a DPDT for $L_1 = \{a^n b^m \mid n \geq 1 \wedge n \leq m\}$ Translating to $a^n b^n$** (Lab 6, Exercise 1)
...
##### **4.13. Build a DPDT for $L_2 = \{xc \mid x \in \{a,b\}^+\}$ Reversing the String** (Lab 6, Exercise 2)
...
##### **4.14. Build a DPDT for $L_1 = \{a^n b^m a^n \mid n \geq 1, m \geq 1\}$ Translating to $a^n b^m$** (Lab 6, Exercise 3)
...
##### **4.15. Build a DPDT for $L_2 = \{a^i b^j c^k \mid i+k = j\}$ Translating to $a^i b^i c^k$** (Lab 6, Exercise 4)
...
##### **4.16. Build a DPDT for $L_4 = \{a^n b^m \mid n \leq m \leq 2n\}$ Translating to $a^n b^n$** (Lab 6, Exercise 5)
