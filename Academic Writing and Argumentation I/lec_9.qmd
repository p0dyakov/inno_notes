---
title: "9. Reading Response Essay, IMRaD Structure"
...
#### **2. Mistakes**
*   **Reading a paper linearly from start to finish:** This is inefficient. It's better to start with the abstract and then jump between sections based on what you need to understand.
*   **Skipping the abstract:** The abstract provides a complete overview and tells you immediately if the paper is relevant to your needs.
*   **Ignoring tables and figures:** Visual data representations are often the core of the results section and can be easier to understand than dense text.
*   **Confusing Results and Discussion:** The Results section presents objective findings (*what*), while the Discussion section provides subjective interpretation (*so what*). It is a mistake to treat the authors' interpretation as a factual result.
*   **Accepting the author's conclusions without question:** Always critically evaluate whether the data presented in the results section actually supports the claims made in the discussion and conclusion.
*   **Not looking up unfamiliar terms or methods:** A superficial understanding can lead to misinterpreting the paper's findings and significance.
