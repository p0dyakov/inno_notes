...
$$\sum_{k=1}^{n} \frac{k}{2^k \cdot (k+1)!} = \frac{(n+2)!}{2^n} - 2$$

**Proof**:

**Base step** ($n = 1$): LHS $= \frac{1}{2 \cdot 2!} = \frac{1}{4}$. RHS $= \frac{3!}{2} - 2 = 3 - 2 = 1$. Wait, this doesn't match. Let me recalculate.

Actually, LHS $= \frac{1}{2 \cdot 2!} = \frac{1}{2 \cdot 2} = \frac{1}{4}$. Hmm, but the source says it equals $1$. Let me check the formula more carefully.

Looking at the source (slide 58), the formula is:

$$\frac{1}{2 \cdot 2!} + \frac{2}{2^2 \cdot 3!} + \frac{3}{2^3 \cdot 4!} + \cdots + \frac{n}{2^n \cdot (n+1)!} = \frac{(n+2)!}{2^n} - 2$$

For $n = 1$: LHS $= \frac{1}{2 \cdot 2!} = \frac{1}{4}$. RHS $= \frac{3!}{2} - 2 = 3 - 2 = 1$.

There's an inconsistency. Let me re-read the source... Ah, I see the issue. The formula in the source uses $\frac{1}{2} \cdot 2!$ which means $\frac{2!}{2} = \frac{2}{2} = 1$, not $\frac{1}{2 \cdot 2!}$. So it's:

$$\frac{1 \cdot 2!}{2} + \frac{2 \cdot 3!}{2^2} + \frac{3 \cdot 4!}{2^3} + \cdots + \frac{n \cdot (n+1)!}{2^n} = \frac{(n+2)!}{2^n} - 2$$

Let me verify for $n = 1$: LHS $= \frac{1 \cdot 2!}{2} = \frac{2}{2} = 1$. RHS $= \frac{3!}{2} - 2 = 3 - 2 = 1$. Good!
...
Thus, it holds for $n = k + 1$. By induction, it holds for all $n \in \mathbb{N}$.
