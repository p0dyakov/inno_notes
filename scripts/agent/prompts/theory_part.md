...
must teach, and every source fact in scope must appear. No water: generic
filler, restated truisms and motivational fluff are forbidden.

Teaching pattern (scaled to the topic's weight):
- DEFINITION first: bold each term, state it formally (math where applicable).
- WHY it matters: a sentence or two of motivation.
- WORKED mini-illustration: a tiny concrete case with real numbers/names.
- PITFALLS: the typical confusion for this topic.
