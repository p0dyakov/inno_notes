---
title: "W5. Expressions in C, Structures, Bit-fields, Alignment, Unions, Enumerations"
...
#### **3. Examples**
##### **3.1. Pack a Date into 2 Bytes using Bit Fields** (Lab 5, Exercise 1)
...
##### **3.2. Parse an IPv4 Header using a Union and Bit Fields** (Lab 5, Exercise 2)
...
##### **3.3. Convert Integer to Weekday using Enum and Switch** (Lab 5, Exercise 3)
...
##### **3.4. Create a Cookbook with an Array of Structures** (Lab 5, Exercise 4)
...
##### **3.5. Sort Structures using Enums** (Lab 5, Exercise 5)
