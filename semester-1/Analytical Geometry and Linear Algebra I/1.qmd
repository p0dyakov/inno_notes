...
#### **4. Examples**
##### **4.1. Finding a Point on a Line Segment** (Lab 1, Task 1)
...
##### **4.2. Finding the Centroid of a Triangle** (Lab 1, Task 2)
...
##### **4.9. Express a Vector as a Linear Combination** (Lecture 1, Example)
...
##### **4.10. Determine Linear Dependence** (Lecture 1, Example)
...
##### **4.11. Check for a Subspace of R²** (Lecture 1, Example 1)
...
##### **4.12. Determine Linear Independence** (Lecture 1, Example)
...
##### **4.13. Check for a Subspace of R²** (Lecture 1, Example 2)
...
##### **4.14. Determine Linear Independence in R²** (Lecture 1, Linear Independence Example)
...
##### **4.15. Prove the Null Space is a Subspace** (Lecture 1, Example 3)
...
##### **4.16. Determine Linear Independence in R³** (Lecture 1, Linear Independence Example)
...
##### **4.17. Describe the Span of a Set of Vectors** (Lecture 1, Example)
...
##### **4.18. Calculate the Norm of a Vector** (Lecture 1, Example)
...
##### **4.19. Calculate the Distance Between Points** (Lecture 1, Example)
...
##### **4.20. Find a Unit Vector** (Lecture 1, Example)
...
##### **4.21. Finding Unknown Coordinates of a Vector** (Tutorial 1, Question 1)
...
##### **4.22. Calculating Triangle Properties from Coordinates** (Tutorial 1, Question 2)
...
##### **4.23. Performing Vector Operations** (Tutorial 1, Question 3)
...
##### **4.24. Showing Linear Dependence and Independence** (Tutorial 1, Question 4)
Show that:
...
##### **4.25. Proving a Set of Polynomials is a Vector Space** (Tutorial 1, Question 5)
...
##### **4.26. Showing a Set is Not a Vector Space** (Tutorial 1, Question 6)
...
##### **4.27. Computing a Vector Projection** (Tutorial 1, Question 7)
...
##### **4.28. Computing a Vector Reflection** (Tutorial 1, Question 8)
Consider the following figure and compute the vector a" in terms of the vectors a and b.
