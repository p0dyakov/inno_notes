...
##### **4.21. Finding Unknown Coordinates of a Vector** (Tutorial 1, Task 1)
...
##### **4.22. Calculating Triangle Properties from Coordinates** (Tutorial 1, Task 2)
...
##### **4.23. Performing Vector Operations** (Tutorial 1, Task 3)
...
##### **4.24. Showing Linear Dependence and Independence** (Tutorial 1, Task 4)
Show that:
...
##### **4.25. Proving a Set of Polynomials is a Vector Space** (Tutorial 1, Task 5)
...
##### **4.26. Showing a Set is Not a Vector Space** (Tutorial 1, Task 6)
...
##### **4.27. Computing a Vector Projection** (Tutorial 1, Task 7)
...
##### **4.28. Computing a Vector Reflection** (Tutorial 1, Task 8)
Consider the following figure and compute the vector a" in terms of the vectors a and b.
...
##### **4.31. Computing Vector Projection and Reflection** (Homework 1, Task 7)
