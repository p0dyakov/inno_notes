...
#### **4. Examples**
##### **4.1. Convert $x = 5$ to Polar Form** (Lab 12, Task 1)
...
##### **4.2. Convert $y = -3$ to Polar Form** (Lab 12, Task 2)
...
##### **4.3. Convert $y = x$ to Polar Form** (Lab 12, Task 3)
...
##### **4.4. Convert $y = 7x$ to Polar Form** (Lab 12, Task 4)
...
##### **4.5. Convert $x^2 + y^2 = 16$ to Polar Form** (Lab 12, Task 5)
...
##### **4.6. Convert $x^2 + y^2 = 2x$ to Polar Form** (Lab 12, Task 6)
...
##### **4.7. Convert $x^2 + y^2 = 9y$ to Polar Form** (Lab 12, Task 7)
...
##### **4.8. Convert $xy = 1$ to Polar Form** (Lab 12, Task 8)
...
##### **4.9. Convert $y = x^2$ to Polar Form** (Lab 12, Task 9)
...
##### **4.10. Convert $x^2 - y^2 = 4$ to Polar Form** (Lab 12, Task 10)
...
##### **4.11. Convert $(x^2 + y^2)^2 = x^2 - y^2$ to Polar Form** (Lab 12, Task 11)
...
##### **4.12. Convert $y = \sqrt{3}x$ to Polar Form** (Lab 12, Task 12)
...
##### **4.13. Convert $x = 0$ to Polar Form** (Lab 12, Task 13)
...
##### **4.14. Convert $x^2 + (y - 2)^2 = 4$ to Polar Form** (Lab 12, Task 14)
...
##### **4.15. Convert $y^2 = 8x$ to Polar Form** (Lab 12, Task 15)
...
##### **4.16. Convert $3x^2 + 4y^2 = 12$ to Polar Form** (Lab 12, Task 16)
...
##### **4.17. Convert $4x^2 - 9y^2 = 36$ to Polar Form** (Lab 12, Task 17)
...
##### **4.18. Convert $x^2 = -12y$ to Polar Form** (Lab 12, Task 18)
...
##### **4.19. Convert $9x^2 + 16y^2 = 144$ to Polar Form** (Lab 12, Task 19)
...
##### **4.20. Convert $r = \frac{4}{1+\cos \theta}$ to Cartesian Form** (Lab 12, Task 20)
...
##### **4.21. Identify Conic from $r = \frac{6}{2-3 \sin \theta}$** (Lab 12, Task 21)
...
##### **4.22. Identify Conic from $r = \frac{3}{1-2 \cos \theta}$** (Lab 12, Task 22)
...
##### **4.23. Line Through Two Points in Polar Coordinates** (Lab 12, Task 23)
...
##### **4.24. Example: Line Through $P_1(2, \frac{\pi}{6})$ and $P_2(3, \frac{\pi}{3})$** (Lab 12, Task 23 Task)
...
##### **4.25. Perpendicular Line Through a Point** (Lab 12, Task 24)
...
##### **4.26. Example: Perpendicular Line** (Lab 12, Task 24 Task)
...
##### **4.41. Practice: Convert $(2\sqrt{3}, -2)$ to Polar** (Lecture 10, Practice 1)
...
##### **4.42. Practice: Convert $(5, \frac{7\pi}{6})$ to Cartesian** (Lecture 10, Practice 2)
...
##### **4.43. Practice: Identify $r = \frac{8}{4 - 2 \cos \theta}$** (Lecture 10, Practice 3)
...
##### **4.44. Practice: Polar Equation with $e = 0.8$, Directrix $x = 5$** (Lecture 10, Practice 4)
