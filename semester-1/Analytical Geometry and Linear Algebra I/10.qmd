...
##### **4.24. Example: Line Through $P_1(2, \frac{\pi}{6})$ and $P_2(3, \frac{\pi}{3})$** (Lab 12, Task 23 Example)
...
##### **4.26. Example: Perpendicular Line** (Lab 12, Task 24 Example)
...
##### **4.37. Simson Line Problem** (Tutorial 10, Task 3)
