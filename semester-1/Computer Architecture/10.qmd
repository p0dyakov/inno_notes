...
#### **3. Examples**
##### **3.1. Array Filling with Constant Value** (Lab 12, Example 1)
...
##### **3.2. Array Filling with Indices** (Lab 12, Discussion Question)
...
##### **3.3. Factorial Calculation** (Lab 12, Task 1)
...
##### **3.4. Word Counting in a String** (Lab 12, Task 2)
...
##### **3.5. Binary Search Implementation** (Lab 12, Optional Task)
...
##### **3.6. Logical Expression Implementation** (Lecture 12, Example)
...
##### **3.7. String Reading and Printing** (Lecture 12, Example)
...
##### **3.8. Fast Multiplication Using Shift** (Lecture 12, Example)
...
##### **3.9. Fast Division Using Shift** (Lecture 12, Example)
...
##### **3.10. Infinite Loop with Jump** (Lecture 12, Example)
...
##### **3.11. Function Call with JAL/JALR** (Lecture 12, Example)
