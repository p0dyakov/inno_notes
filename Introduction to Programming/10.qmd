...
#### **3. Formulas**
*   **Time Complexity (ArrayList access)**: $O(1)$ - Constant time for accessing elements by index
*   **Time Complexity (LinkedList access)**: $O(n)$ - Linear time for accessing elements by index
*   **Time Complexity (HashSet/HashMap operations)**: $O(1)$ - Average case for add, remove, contains, get, put operations
*   **Time Complexity (TreeSet/TreeMap operations)**: $O(\log n)$ - For add, remove, contains, get, put operations due to balanced tree structure
*   **Space Complexity (ArrayList)**: $O(n)$ - Linear space proportional to number of elements
*   **Space Complexity (HashMap)**: $O(n)$ - Linear space proportional to number of entries (with overhead for hash table structure)

#### **4. Examples**

##### **4.1. Separating Interface from Implementation** (Lecture 11, Example 1)
...
##### **4.2. Using Final Methods** (Lecture 11, Example 2)
...
##### **4.3. Creating a Final Class** (Lecture 11, Example 3)
...
##### **4.4. Implementing an Interface** (Lecture 11, Example 4)
...
##### **4.5. Multiple Interface Implementation** (Lecture 11, Example 5)
...
##### **4.6. Interface Inheritance** (Lecture 11, Example 6)
...
##### **4.7. Type Checking with Interfaces** (Lecture 11, Example 7)
...
##### **4.8. Nested Interface** (Lecture 11, Example 8)
...
##### **4.9. Basic Enumeration** (Lecture 11, Example 9)
...
##### **4.10. Enumeration with Fields and Constructor** (Lecture 11, Example 10)
...
##### **4.11. Enum with Method Bodies** (Lecture 11, Example 11)
...
##### **4.12. Enum with values() and ordinal() Methods** (Tutorial 11, Example 1)
...
##### **4.13. Creating and Using an ArrayList** (Tutorial 11, Example 2)
...
##### **4.14. Creating and Using a HashSet** (Tutorial 11, Example 3)
...
##### **4.15. Creating and Using a HashMap** (Tutorial 11, Example 4)
...
##### **4.16. Using an Iterator** (Tutorial 11, Example 5)
...
##### **4.17. Enum Constructor Behavior** (Lab 10, Example 1)
...
##### **4.18. Animals List Program** (Lab 10, Exercise 3)
...
##### **4.19. Remove Odd-Length Strings from Set** (Lab 10, Exercise 4)
...
##### **4.20. Map with Repetitive Value Counter** (Lab 10, Exercise 5)
...
##### **4.21. Online Book Reader System** (Lab 10, Exercise 6 - Homework)
