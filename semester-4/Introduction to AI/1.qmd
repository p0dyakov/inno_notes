...
* **Key Pitfall:** quoting the 0.99 without the date — the ranking is a 2013 snapshot of technical feasibility, not a realised timeline.
...
* **Key Pitfall:** averaging — "jobs grow" and "my entry-level path narrows" are simultaneously true at different slices.
...
* **Key Pitfall:** none — just remember the dream is older than the hardware.
