---
title: "W3. Introduction to Classes, Inheritance, Polymorphism, Virtual Functions, Abstract Classes"
...
#### **3. Examples**
##### **3.1. Inheritance Access Rules - Public, Protected, Private** (Tutorial 3, Example 1)
...
##### **3.2. Virtual Inheritance - Solving the Diamond Problem** (Tutorial 3, Example 2)
...
##### **3.3. Method Overriding vs. Hiding** (Tutorial 3, Example 3)
...
##### **3.4. Polymorphism with Virtual Functions and Destructors** (Tutorial 3, Example 4)
...
##### **3.5. Abstract Classes with Pure Virtual Functions** (Tutorial 3, Example 5)
...
##### **3.6. Complete Object-Oriented Zoo Example** (Lab 3, Task)
