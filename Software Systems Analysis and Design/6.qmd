---
title: "W6. C++ Templates Part 2, Functional Objects, Lambda Expressions"
...
##### **3.1. Analyze Default Template Argument Behavior** (Lecture 6, Example 1)
...
##### **3.2. Explain the Difference Between `Power<5>(1.2)` and `Power<5, int>(1.2)`** (Lecture 6, Example 2)
...
##### **3.3. Explicit Specialization for String Comparison** (Lecture 6, Example 3)
...
##### **3.4. Compile-Time Factorial with Explicit Specializations** (Lecture 6, Example 4)
...
##### **3.5. Partial Specialization for Pointer Types** (Lecture 6, Example 5)
...
##### **3.6. Fibonacci Numbers with Explicit Specializations** (Lecture 6, Exercise 3)
...
##### **3.7. Functional Objects: Generic Find** (Tutorial 6, Problem 1)
...
##### **3.8. Lambda Closures: Capture by Value vs. Reference** (Tutorial 6, Problem 2)
...
##### **3.9. Standard Conversion and Its Prevention** (Lab 6, Problem 1)
...
##### **3.10. Create a Wrapper Class Template with Explicit Specialization** (Lab 6, Task 1)
...
##### **3.11. Implement a Dictionary Class Template with Partial Specialization** (Lab 6, Task 2)
...
##### **3.12. Implement Custom Map and Filter with Lambdas** (Lab 6, Task 3)
