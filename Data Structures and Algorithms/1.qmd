...
#### **4. Examples**
##### **4.1. Compute Asymptotic Worst-Case Time Complexity** (Problem Set 1, Problem 1)
...
##### **4.2. Loop Invariant Proof for Reorder Algorithm** (Problem Set 1, Problem 2)
...
##### **4.3. Asymptotic Notation: True or False** (Problem Set 1, Problem 3)
...
##### **4.4. Prove $2^{n+1} = O(2^n)$** (Lecture 1, Exercise 1)
...
##### **4.6. Prove $\max(f(n), g(n)) = \Theta(f(n) + g(n))$** (Lecture 1, Exercise 3)
...
##### **4.7. Prove $(n + a)^b = \Theta(n^b)$** (Lecture 1, Exercise 4)
...
##### **4.8. Prove Product Rule for $O$-notation** (Lecture 1, Exercise 5)
...
##### **4.9. Prove that $k \ln k = \Theta(n)$ implies $k = \Theta(n / \ln n)$** (Lecture 1, Exercise 6)
...
##### **4.11. Prove Correctness and Analyze exp1 Algorithm** (Lab 1, Exercise 1)
...
##### **4.12. Prove Correctness and Analyze exp2 Algorithm** (Lab 1, Exercise 2)
...
##### **4.13. GCD Algorithm (Naive)** (Lab 1, Exercise 3)
...
##### **4.14. Euclidean GCD Algorithm** (Lab 1, Exercise 4)
