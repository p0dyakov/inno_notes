...
##### **4.9. Normal Vector and Orthogonal Complement of a Plane** (Assignments 4, Problem 1)
...
##### **4.10. Four Subspaces of a Parametric Matrix** (Assignments 4, Problem 2)
...
##### **4.11. Four Subspaces of $A$, $A+I$, and $A+A^2$** (Assignments 4, Problem 3)
...
##### **4.12. Is $w$ in $\text{Col}(A)$ or $\text{Nul}(A)$? (First Matrix)** (Assignments 4, Problem 4)
...
##### **4.13. Is $w$ in $\text{Col}(A)$ or $\text{Nul}(A)$? (Second Matrix)** (Assignments 4, Problem 5)
...
##### **4.14. Subspaces in $\mathbb{R}^n$ vs $\mathbb{R}^m$** (Assignments 4, Problem 6)
...
##### **4.15. Justifying the Rank-Nullity Identities** (Assignments 4, Problem 7)
...
##### **4.16. Equivalence: Full Column Space, Nul$(A^T) = \{0\}$, Consistency** (Assignments 4, Problem 8)
...
##### **4.17. Normal Vectors and Orthogonal Complement Construction** (Assignments 4, Problem 9)
...
##### **4.18. Four Subspaces from Row-Equivalent Matrices** (Assignments 4, Problem 10)
...
##### **4.19. Four Subspaces and Orthogonality Verification** (Assignments 4, Problem 11)
...
##### **4.20. Four Subspaces of a $2 \times 5$ Matrix** (Assignments 4, Problem 12)
...
##### **4.21. Dimensions of Four Subspaces Depending on Parameters** (Assignments 4, Problem 13)
